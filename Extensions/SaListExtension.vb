...
Namespace Extensions
    Public Module SaListExtension
        <Extension()>
        Public Function ToDataTable(Of T As Class)(ByVal data As List(Of T)) As DataTable
        ...
        <Extension()>
        Public Function a(Of T)(ByVal root As List(Of T), ByVal data As T) As List(Of T)
            root.Add(data)
            Return root
        End Function
