...
Namespace SaWindows.Forms
    Public Class SaCalendarColumn
        ...
        Public Overrides Property CellTemplate() As DataGridViewCell
            ...
            Set(ByVal value As DataGridViewCell)
                ...
                Not value.GetType().IsAssignableFrom(GetType(SaCalendarCell)) _
                Then
                    Throw New InvalidCastException("Must be a SaCalendarCell")
                End If
    ...
    Public Class SaCalendarCell
        ...
        ByVal dataGridViewCellStyle As DataGridViewCellStyle)
            ...
            If Not (Me.Value Is Nothing OrElse IsDBNull(Me.Value)) Then
                ctl.Value = CType(Me.Value, DateTime)
            End If
        End Sub
